...
fdds = type=http-response,pattern=^https:\/\/api\.dushu\.io\/(userInfo|checkin\/status|books\/freeList|app\/hasUserBlackCard),requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Zhiiqiiang/HZZQ/master/fdds2.js,script-update-interval=0
